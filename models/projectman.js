...
module.exports = {
  ...
  getDataProjectmanByIDModel: (id) => {
    return new Promise((resolve, reject) => {
      db.query(`select table_project.image, table_company.id_company, table_company.company_name, table_project.name_project, table_projectman.order_worker, table_projectman.id_project, table_projectman.message, table_projectman.price, table_projectman.project_job, table_projectman.status
